...
- ✅ **Поиск мэтчей после удаления пользователя** (кнопка "Больше не ищу")
- ✅ **Удаленный пользователь не появляется в результатах**
- ✅ **Поиск после удаления нескольких пользователей**
- ✅ **Двусторонние мэтчи после удаления**
- ✅ **Частичные мэтчи после удаления**
- ✅ **CASCADE удаление желаемых групп**
